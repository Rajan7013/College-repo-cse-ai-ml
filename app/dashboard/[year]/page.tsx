    ...
    return (
        <div className="min-h-screen py-8 px-4">
            <div className="max-w-7xl mx-auto">
                {/* Breadcrumbs / Back */}
                <Link href="/dashboard" className="inline-flex items-center gap-2 glass-card px-4 py-2 mb-8 hover:bg-white/10 transition-all">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    {SEMESTERS.map((sem) => (
                        <Link
                            key={sem}
                            href={`/dashboard/${year}/${sem}?regulation=${regulation}`}
                            className="group"
                        >
