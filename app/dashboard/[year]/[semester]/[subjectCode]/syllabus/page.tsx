    ...
    return (
        <div className="min-h-screen py-8 px-4">
            <div className="max-w-5xl mx-auto">
                <Link href={`/dashboard/${year}/${semester}/${subjectCode}?regulation=${regulation}`} className="inline-flex items-center gap-2 glass-card px-4 py-2 mb-8 hover:bg-white/10 transition-all">
