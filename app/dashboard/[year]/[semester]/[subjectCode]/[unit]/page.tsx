        ...
        <div className="min-h-screen py-8 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8 flex flex-wrap items-center gap-3">
                    <Link href={`/dashboard/${year}/${semester}/${subjectCode}?regulation=${regulation}`} className="glass-card px-4 py-2 hover:bg-white/10 transition-all flex items-center gap-2 text-sm text-blue-200">
