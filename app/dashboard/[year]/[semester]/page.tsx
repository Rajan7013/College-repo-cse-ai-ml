        ...
        <div className="min-h-screen py-8 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                    <Link href="/dashboard" className="glass-card px-4 py-2 hover:bg-white/10 transition-all text-blue-200 hover:text-white text-sm font-semibold">
                        Years
                    </Link>
                    ...
                    {subjects.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {subjects.map((sub) => (
                                <Link
                                    key={sub.code}
                                    href={`/dashboard/${year}/${semester}/${sub.code}?regulation=${regulation}`}
                                    className="group"
                                >
