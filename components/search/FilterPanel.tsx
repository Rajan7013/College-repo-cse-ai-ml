...
export default function FilterPanel({ filters, onChange, onApply }: FilterPanelProps) {
    ...
    useEffect(() => {
        ...
        if (filters.regulation || filters.year || filters.semester) {
            fetchSubjects();
        }
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
            ...
            {/* Filters */}
            {expanded && (
                <div className="px-4 py-3 space-y-3 border-t border-slate-100 max-h-[70vh] overflow-y-auto">
                    {/* Regulation */}
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-100"
                        >
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-100 disabled:bg-slate-50 disabled:text-slate-400"
                        >
                        ...
                        {loadingSubjects && <p className="text-xs text-slate-500 mt-1">Loading...</p>}
                    </div>
                    ...
                    <div className="flex gap-2 pt-3 border-t border-slate-100">
                        ...
                        <button
                            onClick={handleReset}
                            className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-lg transition-colors flex items-center gap-1 text-sm"
                        >
                            <X className="h-4 w-4" />
                            Reset
                        </button>
