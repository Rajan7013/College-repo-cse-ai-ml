        ...
        <div className="glass-card">
            ...
            {expanded && (
                <div className="px-4 py-3 border-t border-white/10">
                    {/* Filters Grid - 2 columns on desktop, 1 on mobile */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-2.5 lg:gap-y-2 max-h-[70vh] lg:max-h-none overflow-y-auto lg:overflow-visible custom-scrollbar">
                        {/* Regulation */}
                        <div>
